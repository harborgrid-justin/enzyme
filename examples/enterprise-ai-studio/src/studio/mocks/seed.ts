...
export function synthesizeReply(
  ...
  return (
    ...
    `Want me to draft the slice, or first stress-test the assumptions?\n\n` +
    `_Reply generated by ${modelLabel} (mock). This is a simulated response — no real provider was called._`
  );
}
